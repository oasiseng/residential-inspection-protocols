...
Built by [Oasis Engineering](https://github.com/oasiseng) — a structural and forensic engineering firm based in Florida. These protocols are what we actually use in the field on single-family residential (SFR) projects, and we're sharing them so junior engineers, building inspectors, and contractors have a reliable, code-grounded reference instead of guessing or relying on generic AI outputs that miss critical details.
